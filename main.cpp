/**
    \file main.cpp
    \author Tim Robbins
    \brief Test file, just to run examples from the random number generation. \n
    ...
    \todo I set the perlin function wrong and would hope to display using octaves to create managable noise. \n
